<template>
  ...
  <div class="itemTopFooter">
    ...
    <van-popup v-model:show="commentshow" position="bottom" :style="{ height: '60%',width:'100%' }" round="isround" close-on-click-overlay="isclose">
...
export default {
  name:'ItemMusicTop',
  computed:{
    ...mapState(['commentshow','isround','isclose'])
  },
  methods:{
