        ...
        <div class="ContentLeft">
          <div class="itemName">
            <span class="spanLeft">
              ...
              <svg class="icon" aria-hidden="true" @click="DeCommentLike(item.commentId,item.likedCount)" v-else>
                <use xlink:href="#icon-aixin"></use>
              </svg>
  ...
  methods:{
    CommentLike:async function(cid,item){
      ...
      if(res.data.code === 200){
        ...
        // res.data.code = localStorage.getItem("LikeCount",JSON.parse(this.LikeCount)).code
      }
      console.log(res);
    },
    DeCommentLike:async function(cid,likedCount){
      ...
      if(res.data.code === 200){
        ...
        localStorage.setItem("Like",JSON.stringify(res.data.code))
      }else if(res.data.code===302){
        res.data.code = localStorage.getItem("LikeCount",JSON.parse(this.LikeCount))
      }
    }
