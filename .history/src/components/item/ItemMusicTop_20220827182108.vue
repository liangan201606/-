<template>
  ...
  <div class="itemTopFooter">
    ...
    <van-popup v-model:show="commentshow" position="bottom" :style="{ height: '70%',width:'100%' }" round click-overlay="updataCommentShow">
      <CommentList :CommentList="state.CommentList" :id="id"></CommentList>
    </van-popup>
  </div>
</template>
...
import {getCommentList} from '../../request/api/item.js'
...
export default {
  ...
  setup(props){
    ...
    return{changeCount,CommentShow,state,id}
  },
  props:['playList']
}
</script>
