<template>
  ...
  <div class="itemTopFooter">
    ...
    <van-popup v-model:show="commentshow" position="bottom" :style="{ height: '70%',width:'100%' }" round>
      <CommentList :CommentList="state.CommentList" @click="updataCommentShow"></CommentList>
    </van-popup>
  </div>
</template>
...
export default {
  ...
  setup(props){
    ...
    return{changeCount,CommentShow,state}
  },
  props:['playList']
}
</script>
