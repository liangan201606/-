<template>
  <div class="footerMusic">
    ...
    <van-popup v-model:show="detailShow" position="right" :style="{ height: '100%',width:'100%' }">
      <MusicDetial :musicList="songList[songListIndex]" :isBtnShow="isBtnShow" :play="play" :addDuration="addDuration"></MusicDetial>
    </van-popup>
  </div>
</template>
...
export default {
  ...
  computed:{
    ...mapState(['songList','songListIndex','isBtnShow','detailShow','duration'])
  },
  mounted() {
  ...
  methods: {
    ...
    ...mapMutations(['updateIsBtnShow','updateDetailShow','updataCurrentTime','updataduration'])
  },
  watch:{
