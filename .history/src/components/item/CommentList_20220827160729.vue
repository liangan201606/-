        ...
        <div class="ContentLeft">
          <div class="itemName">
            <span class="spanLeft">
              ...
              <span class='Like' @click="Count">{{item.likedCount}}</span>
              <svg class="icon" aria-hidden="true" @click="CommentLike(item.commentId,item.likedCount,item.liked)" v-if="!isliked">
...
export default {
  ...
  methods:{
    CommentLike:async function(cid,likedCount,liked){
      // 获取歌单id
      let id = this.id
      let t= 1
