        ...
        <div class="ContentLeft">
          <div class="itemName">
            <span class="spanLeft">
              ...
              <svg class="icon" aria-hidden="true" @click="CommentLike(item.commentId,i)" v-if="!isliked">
                <use xlink:href="#icon-aixin"></use>
              </svg>
              <svg class="icon" aria-hidden="true" @click="DeCommentLike(item.likedCount)" v-else>
                <use xlink:href="#icon-aixin"></use>
              </svg>
