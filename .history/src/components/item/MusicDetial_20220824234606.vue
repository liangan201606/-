<template>
  <div class="musicDetail">
    ...
    <div class="content" v-show="!isLyricShow">
      ...
      <img :src="musicList.al.picUrl" alt="" class="img_ar" :class="{img_ar_active:!isBtnShow,img_ar_paused:isBtnShow}" @click="isLyricShow=truee">
    </div>
    <div class="lyricList" ref="lyricShow" v-show="isLyricShow">
      <!-- 在出现该歌词到下一句歌词出现之间 -->
