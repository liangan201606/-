<template>
  ...
  <div class="itemTopFooter">
    ...
    <van-popup v-model:show="commentshow" position="bottom" :style="{ height: '60%',width:'100%' }" round="true" close-on-click-overlay="true">
...
export default {
  name:'ItemMusicTop',
  computed:{
    ...mapState(['commentshow','round','close-on-click-overlay'])
  },
  methods:{
