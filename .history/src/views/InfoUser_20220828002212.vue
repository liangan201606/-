<template>
  <div class="UserTop">
    <img :src="user2.backgroundUrl" alt="" class="backPic">
     <svg class="icon" aria-hidden="true" @click="$router.push('/')">
          <use xlink:href="#icon-zuojiantou"></use>
    </svg>
    <!-- <img src="../assets/网易云音乐-01.svg" alt="" class="backPic"> -->
    <div class="User">
        <img :src="user2.avatarUrl" alt="" class="nickPic">
        <p class="nickname">{{user2.nickname}}</p>
...
export default {
  ...
  mounted(){
    this.user2 = JSON.parse(localStorage.getItem('usermgs'))
